...
export interface SimpleAccountFactoryInterface extends utils.Interface {
  functions: {
    ...
    "createAccount(bytes32,uint256[2],address,uint256)": FunctionFragment;
    "getAddress(bytes32,uint256[2],address,uint256)": FunctionFragment;
  };
...
export interface SimpleAccountFactory extends BaseContract {
  ...
  functions: {
    ...
    createAccount(
      credentialIdHash: PromiseOrValue<BytesLike>,
