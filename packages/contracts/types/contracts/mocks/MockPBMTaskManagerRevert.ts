...
export interface MockPBMTaskManagerRevertInterface extends utils.Interface {
  functions: {
...
export interface MockPBMTaskManagerRevert extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockPBMTaskManagerRevertInterface;
