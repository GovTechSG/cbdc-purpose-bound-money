      ...
      testMatrixAutoWithdrawal.forEach((autoWithdrawal) => {
        describe(`When autoWithdrawal is ${autoWithdrawal}`, () => {
          beforeEach(async () => {
            ...
            await pbmContract
              .connect(payer)
              .pay(payee.address, paidAmount, lockPeriod, autoWithdrawal);
            ...
            describe("When withdrawing the deposit", () => {
              ...
              describe("When the deposit has been withdrawn", () => {
                ...
                beforeEach(async () => {
                  ...
                  initialPbmUnderlyingAssetBalance = await dsgdContract.balanceOf(
                    pbmContract.address,
                  );
                ...
                it("should not withdraw the underlying asset", async () => {
                  const pbmUnderlyingAssetBalance = await dsgdContract.balanceOf(
                    pbmContract.address,
                  );
      ...
      testMatrixAutoWithdrawal.forEach((autoWithdrawal) => {
        describe(`When autoWithdrawal is ${autoWithdrawal}`, () => {
          beforeEach(async () => {
            ...
            await pbmContract
              .connect(payer)
              .pay(payee1.address, parseAmount(100), lockPeriod, autoWithdrawal);
            // Pay to payee2
            await pbmContract
              .connect(payer)
              .pay(payee2.address, parseAmount(100), lockPeriod, autoWithdrawal);
            ...
            await pbmContract
              .connect(payer)
              .pay(payee2.address, parseAmount(100), 3600 * 24 * 30, autoWithdrawal);
